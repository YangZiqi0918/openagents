...
export type ViewMode = 'threads' | 'projects' | 'files' | 'knowledge' | 'browser' | 'tasks' | 'workflows' | 'routines' | 'inbox' | 'connect' | 'skills';
...
export const RAIL_WIDTH_EXPANDED = 264;
...
interface LayoutState {
  ...
  setDraftThreadOpen: (v: boolean) => void;
