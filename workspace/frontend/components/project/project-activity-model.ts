...
const COPY = {
  'zh-CN': {
    ...
    chooseAgents: '选择当前项目的智能体',
    noOnlineAgents: '当前项目暂无在线智能体，可创建纯成员会话',
    leader: '负责人',
    noLeader: '未指定',
    mentionMember: '提及项目成员',
    noHumanMembers: '暂无可提及的项目成员',
    membersFailed: '无法加载项目成员',
    follow: '关注会话',
    unfollow: '取消关注',
    subscriptionFailed: '无法更新会话关注状态',
    noAgents: '暂无 Agent',
    back: '返回会话列表',
    share: '复制项目链接',
    copied: '链接已复制',
    ...
    sendFailed: '发送失败',
    agentNotJoined: '智能体尚未加入会话，请从 @ 菜单重新选择后发送',
    agentOffline: '智能体已离线，请选择当前在线的智能体',
    memberNotFound: '成员已不在此项目，请刷新成员名单后重试',
    workflowStepOnly: '工作流运行中，只能提及当前步骤的智能体',
    retrySend: '重新发送',
    dismiss: '取消重发',
  ...
  'en-US': {
    ...
    chooseAgents: 'Agents in this project',
    noOnlineAgents: 'No agents online in this project; you can create a people-only conversation',
    leader: 'Lead agent',
    noLeader: 'Not assigned',
    mentionMember: 'Mention project member',
    noHumanMembers: 'No project members to mention',
    membersFailed: 'Could not load project members',
    follow: 'Follow conversation',
    unfollow: 'Unfollow conversation',
    subscriptionFailed: 'Could not update conversation notifications',
    ...
    agentNotJoined: 'Agent is not in this conversation. Select it from the @ menu before sending.',
    agentOffline: 'Agent is offline. Select an online project agent.',
    memberNotFound: 'Member is no longer in this project. Refresh the member list and retry.',
    workflowStepOnly: 'Only the current workflow step agent can be mentioned.',
